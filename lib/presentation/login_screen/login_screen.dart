import 'package:loginform/presentation/login_screen/controller/login_controller.dart';
...
import 'package:loginform/widgets/custom_outlined_button.dart';
import 'package:loginform/widgets/custom_text_form_field.dart';
import 'package:loginform/domain/googleauth/google_auth_helper.dart';
import 'package:loginform/domain/facebookauth/facebook_auth_helper.dart';
...
class LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  onTapSignIn(BuildContext context) {
    ...
    /*ref.read(userControllerProvider.notifier).login(
      email: ref.watch(loginNotifier).emailController!.text,
      password: ref.watch(loginNotifier).passwordController!.text,
    ).then((response) => {
      response.fold(
        (l) => {
        ...
        (r) => {
          // on success then navigate to dashboard
          NavigatorService.pushNamed(
            AppRoutes.dashboardContainerScreen,
          ),
        },
