import 'notifier/notification_activity_notifier.dart';
...
class NotificationActivityScreen extends ConsumerStatefulWidget {
  ...
  @override
  NotificationActivityScreenState createState() =>
      NotificationActivityScreenState();
}

class NotificationActivityScreenState
            ...
            body: Container(
                ...
                child: Column(children: [
                  _buildActivityDetails(context,
                      ...
                      transactionDescription: "msg_culpa_cillum_consectetur".tr,
