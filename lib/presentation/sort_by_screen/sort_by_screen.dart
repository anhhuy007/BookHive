import 'notifier/sort_by_notifier.dart';
...
class SortByScreen extends ConsumerStatefulWidget {
  const SortByScreen({Key? key}) : super(key: key);

  @override
  SortByScreenState createState() => SortByScreenState();
}

class SortByScreenState extends ConsumerState<SortByScreen> {
  @override
